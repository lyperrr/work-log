...
export function DatePicker({ value, onChange, placeholder = "Pilih tanggal..." }) {
  ...
  return (
    <div className="w-full">
      <Popover>
        <PopoverTrigger
          className="w-full h-13 flex items-center justify-between text-left font-bold text-base border border-input rounded-xl touch-btn px-4 bg-background text-foreground hover:bg-accent/50 focus:border-primary focus:ring-4 focus:ring-primary/20 outline-none transition-all shadow-xs cursor-pointer"
        >
